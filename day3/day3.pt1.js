...
function traverseSchematic(inputGrid, gear) {
    ...
    console.log("ANSWER: TOTAL SUM:", partNumberSum)
}
...
function completePartNumber(y, x) {
    ...
    while (partNumberFound(inputGrid[y][xLeft])) {
        ...
        inputGrid[y][xLeft] = '.'; // Update the grid after checking the part number
        xLeft = xLeft - 1;
    }
    ...
    while (partNumberFound(inputGrid[y][xRight])) {
        ...
        inputGrid[y][xRight] = '.'; // Update the grid after checking the part number
        xRight = xRight + 1;
    }
...
function part1(inputGrid) {
    traverseSchematic(inputGrid, false)
}
